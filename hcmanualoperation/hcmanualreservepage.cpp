    ...
    clips_(6, false)
{
    ...
    ui->reserve3StatusLabel->hide();
    ui->connectReserve3ToolButton->hide();
    ui->disconnectReserve3ToolButton->hide();
    ui->label_4->hide();

    ui->reserve4StatusLabel->hide();
    ui->connectReserve4ToolButton->hide();
    ui->disconnectReserve4ToolButton->hide();
    ui->label_3->hide();
