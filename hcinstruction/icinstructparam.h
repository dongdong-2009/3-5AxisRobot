...
public:
    ...
    static QString ConvertCommandStr(const ICMoldItem & moldItem, const QList<int>& curPos = QList<int>(), bool isFirstDown = false, bool isUD = false);

    static bool BeforeWaitMoldOpen;
