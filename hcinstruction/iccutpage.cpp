...
//    ICLineEditWithVirtualNumericKeypad *delayEdit;
    ...
    onClipToOffClip_.insert(ICMold::ACTCLIP8ON + 100, ICMold::ACTCLIP8OFF + 100);
    onClipToOffClip_.insert(ICMold::ACTCLIP8ON + 101, ICMold::ACTCLIP8OFF + 101);
...
//        ui->tableWidget->setCellWidget(i, 2, delayEdit);
    ...
    commandKeyMap_.insert(settingButtons_.at(9), qMakePair(static_cast<int>(IC::VKEY_CLIP8ON), static_cast<int>(IC::VKEY_CLIP8OFF)));
