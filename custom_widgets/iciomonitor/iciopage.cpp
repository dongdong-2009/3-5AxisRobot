...
const QString Y020 = "Y020";
const QString Y021 = "Y021";
    ...
    outputOnPixmap_(":/resource/ledgreen(16).png")
{
    ...
    multiLabels.insert(X021, labelNull);
...
//    multiLabels.insert(Y017, labelNull);
    multiLabels.insert(Y020, labelNull);
    multiLabels.insert(Y021, labelNull);
...
//    }
    ...
    {
        multiLabels.value(X020)->setText(tr("C Origin"));
        multiLabels.value(X021)->setText(tr("C end limit"));
    ...
    {
        multiLabels.value(X020)->setText(tr("Horizon-1 Limit"));
        multiLabels.value(X021)->setText(tr("Vertical-1 Limit "));

        multiLabels.value(Y020)->setText(tr("Horizon-1 Valve"));
        multiLabels.value(Y021)->setText(tr("Vertical-1 Valve "));
    }
    else
    {
        multiLabels.value(X021)->setText(tr("Horizon-1 Limit"));
        multiLabels.value(X020)->setText(tr("Vertical-1 Limit"));
        multiLabels.value(Y021)->setText(tr("Horizon-1 Valve"));
        multiLabels.value(Y020)->setText(tr("Vertical-1 Valve"));
    }
...
//    }
    ...
    {
        multiLabels.value(X022)->setText(tr("A Origin"));
        multiLabels.value(X023)->setText(tr("A begin limit"));
...
//        multiLabels.value(X037)->setText(tr("Vertical-2 Limit "));
    ...
    {
//        multiLabels.value(X022)->setText(tr("M0"));
//        multiLabels.value(X023)->setText(tr("X037"));
//        multiLabels.value(Y022)->setText(tr("Y024"));
//        multiLabels.value(Y023)->setText(tr("Y046"));
    }
    else if(ICVirtualHost::GlobalVirtualHost()->FixtureDefine() == 1)
    {
        multiLabels.value(X022)->setText(tr("Horizon-2 Limit"));
        multiLabels.value(X023)->setText(tr("Vertical-2 Limit "));

        multiLabels.value(Y022)->setText(tr("Horizon-2 Valve"));
        multiLabels.value(Y023)->setText(tr("Vertical-2 Valve "));
    }
    else
    {
        multiLabels.value(X022)->setText(tr("Horizon-2 Limit"));
